...
equal(timing_log[2], "ON_OPPONENT_ATTACK", "opponent-attack second")
equal(timing_log[3], "ON_BLOCK", "on-block after redirect")
equal(timing_log[4], "ON_OPPONENT_BLOCKER_ACTIVATED", "blocker reaction timing")
